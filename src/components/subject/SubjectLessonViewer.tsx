        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 bg-card/40">
          <div 
            className="prose prose-slate dark:prose-invert max-w-none text-foreground leading-relaxed break-words
              ...
              prose-table:w-full prose-table:border-collapse prose-th:bg-muted/60 prose-th:p-2.5 prose-th:border prose-td:p-2.5 prose-td:border
              prose-blockquote:border-l-4 prose-blockquote:border-primary prose-blockquote:bg-muted/20 prose-blockquote:p-4 prose-blockquote:rounded-r-lg prose-blockquote:italic"
